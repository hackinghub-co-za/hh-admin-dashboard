...
export default function AdminDashboard({ activeTab, providerToken }) {
  ...
  const [payments, setPayments] = useState([
    ...
    { id: 5, pfId: 'PF-18467178-905', member: 'Nonhlanhla Sindane', email: 'nonhlanhla@hh.co.za', plan: 'Monthly Operative', amount: 600, date: '2026-08-01 16:30', status: 'COMPLETE', gateway: 'PayFast' },
  ]);
