 ...
 * LinkedIn, specialty, job readiness, employment status/job title). Excludes
 * sensitive fields (money owed, phone, age/gender, etc.) at the RPC level. */
 ...
 * these 7 public-facing columns on their own row. */
export async function updateMyDirectoryProfile({ fullName, about, location, linkedin, specialty, employmentStatus, jobTitle }) {
