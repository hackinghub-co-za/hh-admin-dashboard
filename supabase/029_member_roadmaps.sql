...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM public.roadmap_items
    WHERE member_email = 'ululamilemabunda@gmail.com' AND NOT (phase = 'Core Foundations' AND category = 'Certifications')
  ) THEN
    INSERT INTO public.roadmap_items (member_email, phase, category, title, detail, completed, sort_order) VALUES
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM public.roadmap_items
    WHERE member_email = 'jessexavier2@gmail.com' AND NOT (phase = 'Core Foundations' AND category = 'Certifications')
  ) THEN
    INSERT INTO public.roadmap_items (member_email, phase, category, title, detail, completed, sort_order) VALUES
