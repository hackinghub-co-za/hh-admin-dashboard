...
-- Chioma Olebuike (chiomaolebuike14@gmail.com) - DevSecOps track. No catalog
...
UPDATE public.member_profiles SET roadmap_track = 'DevSecOps' WHERE email = 'chiomaolebuike14@gmail.com';
