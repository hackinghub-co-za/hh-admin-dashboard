...
- **Status**: Logged, needs a careful fix with real deploy/test access - not attempted, per the fix policy's PayFast/payment-logic boundary. This is the single highest-priority item in the whole QA log to date.
